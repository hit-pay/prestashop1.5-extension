...
require_once _PS_MODULE_DIR_ . 'hitpay/vendor/Client.php';
...
class HitpayRedirectModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        try {
            ...
            $this->module->log('Redirect Request:');
            $this->module->log((array)($create_payment_request));
            $result = $hitpay_client->createPayment($create_payment_request);
            $this->module->log('Redirect Response:');
            $this->module->log((array)($result));
            ...
            $this->module->log('Redirect Catch:'.$e->getMessage());
