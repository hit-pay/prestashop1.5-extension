...
require_once _PS_MODULE_DIR_ . 'hitpay/vendor/Request.php';
require_once _PS_MODULE_DIR_ . 'hitpay/vendor/CurlEmulator.php';
require_once _PS_MODULE_DIR_ . 'hitpay/vendor/Request/CreatePayment.php';
require_once _PS_MODULE_DIR_ . 'hitpay/vendor/Response/CreatePaymentResponse.php';
require_once _PS_MODULE_DIR_ . 'hitpay/vendor/Response/DeletePaymentRequest.php';
require_once _PS_MODULE_DIR_ . 'hitpay/vendor/Response/PaymentStatus.php';
require_once _PS_MODULE_DIR_ . 'hitpay/vendor/Response/Refund.php';
